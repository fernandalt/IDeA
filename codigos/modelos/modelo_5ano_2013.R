...
set.seed(1000)
modelo.Completo.5ano.lp.09.13= lme(Leitura ~ as.factor(Ano) + Sexo + Raça + classificacao_NSE+NSE_Escola, random = ~  classificacao_NSE+Raça+Sexo|ID_MUNICIPIO, 
...
set.seed(1000)
modelo.Completo.5ano.mat.09.13= lme(Matematica ~ as.factor(Ano) + Sexo + Raça + classificacao_NSE+NSE_Escola, random = ~  classificacao_NSE+Raça+Sexo|ID_MUNICIPIO, 
