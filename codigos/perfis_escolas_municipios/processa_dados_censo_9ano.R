...
dados_matricula_co[Segmento_Ensino=='Fundamental II',
...
save(prop_sexo_escola_co,file='Prop_sexo_escola_co_9ano.Rdata')
save(prop_raca_escola_co,file='Prop_raca_escola_co_9ano.Rdata')
...
save(prop_sexo_escola_nordeste,file='Prop_sexo_escola_nordeste_9ano.Rdata')
save(prop_raca_escola_nordeste,file='Prop_raca_escola_nordeste_9ano.Rdata')
...
save(prop_sexo_escola_sudeste,file='Prop_sexo_escola_sudeste_9ano.Rdata')
save(prop_raca_escola_sudeste,file='Prop_raca_escola_sudeste_9ano.Rdata')
...
save(prop_sexo_escola_norte,file='Prop_sexo_escola_norte_9ano.Rdata')
save(prop_raca_escola_norte,file='Prop_raca_escola_norte_9ano.Rdata')
...
save(prop_sexo_escola_sul,file='Prop_sexo_escola_sul_9ano.Rdata')
save(prop_raca_escola_sul,file='Prop_raca_escola_sul_9ano.Rdata')
