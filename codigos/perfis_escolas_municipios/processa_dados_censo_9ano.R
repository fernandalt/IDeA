...
# proporcoes                                          
prop_raca_escola_co = dados_matricula_co[Segmento_Ensino=='Fundamental II',
...
prop_sexo_escola_co = dados_matricula_co[Segmento_Ensino=='Fundamental II',
...
# proporcoes                                          
prop_raca_escola_nordeste = dados_matricula_nordeste[Segmento_Ensino=='Fundamental II',
                                                     .(prop_branco=sum(TP_COR_RACA=='Branca',na.rm=T)/sum(!is.na(TP_COR_RACA)),
                                                       prop_preto=sum(TP_COR_RACA=='Preta',na.rm=T)/sum(!is.na(TP_COR_RACA))),
                                                     by=CO_ENTIDADE]

prop_sexo_escola_nordeste = dados_matricula_nordeste[Segmento_Ensino=='Fundamental II',
                                                     .(prop_masculino=sum(TP_SEXO=='Masculino',na.rm=T)/sum(!is.na(TP_SEXO)),
                                                       prop_feminino=sum(TP_SEXO=='Feminino',na.rm=T)/sum(!is.na(TP_SEXO))),
                                                     by=CO_ENTIDADE]
...
# proporcoes
prop_raca_escola_sudeste = dados_matricula_sudeste[Segmento_Ensino=='Fundamental II',
                                                   .(prop_branco=sum(TP_COR_RACA=='Branca',na.rm=T)/sum(!is.na(TP_COR_RACA)),
                                                     prop_preto=sum(TP_COR_RACA=='Preta',na.rm=T)/sum(!is.na(TP_COR_RACA))),
                                                   by=CO_ENTIDADE]

prop_sexo_escola_sudeste = dados_matricula_sudeste[Segmento_Ensino=='Fundamental II',
                                                   .(prop_masculino=sum(TP_SEXO=='Masculino',na.rm=T)/sum(!is.na(TP_SEXO)),
                                                     prop_feminino=sum(TP_SEXO=='Feminino',na.rm=T)/sum(!is.na(TP_SEXO))),
                                                   by=CO_ENTIDADE]
...
# proporcoes
prop_raca_escola_norte = dados_matricula_norte[Segmento_Ensino=='Fundamental II',
                                               .(prop_branco=sum(TP_COR_RACA=='Branca',na.rm=T)/sum(!is.na(TP_COR_RACA)),
                                                 prop_preto=sum(TP_COR_RACA=='Preta',na.rm=T)/sum(!is.na(TP_COR_RACA))),
                                               by=CO_ENTIDADE]

prop_sexo_escola_norte = dados_matricula_norte[Segmento_Ensino=='Fundamental II',
                                               .(prop_masculino=sum(TP_SEXO=='Masculino',na.rm=T)/sum(!is.na(TP_SEXO)),
                                                 prop_feminino=sum(TP_SEXO=='Feminino',na.rm=T)/sum(!is.na(TP_SEXO))),
                                               by=CO_ENTIDADE]
...
# proporcoes
prop_raca_escola_sul = dados_matricula_sul[Segmento_Ensino=='Fundamental II',
                                           .(prop_branco=sum(TP_COR_RACA=='Branca',na.rm=T)/sum(!is.na(TP_COR_RACA)),
                                             prop_preto=sum(TP_COR_RACA=='Preta',na.rm=T)/sum(!is.na(TP_COR_RACA))),
                                           by=CO_ENTIDADE]

prop_sexo_escola_sul = dados_matricula_sul[Segmento_Ensino=='Fundamental II',
                                           .(prop_masculino=sum(TP_SEXO=='Masculino',na.rm=T)/sum(!is.na(TP_SEXO)),
                                             prop_feminino=sum(TP_SEXO=='Feminino',na.rm=T)/sum(!is.na(TP_SEXO))),
                                           by=CO_ENTIDADE]
...
save(prop_sexo_escola_co,
     file=paste0(dirname(dirname(wd)), "/dados/perfis_escolas_municipios/Prop_sexo_escola_co_9ano.Rdata"))

save(prop_raca_escola_co,
     file=paste0(dirname(dirname(wd)), "/dados/perfis_escolas_municipios/Prop_raca_escola_co_9ano.Rdata"))

save(prop_sexo_escola_nordeste,
     file=paste0(dirname(dirname(wd)), "/dados/perfis_escolas_municipios/Prop_sexo_escola_nordeste_9ano.Rdata"))

save(prop_raca_escola_nordeste,
     file=paste0(dirname(dirname(wd)), "/dados/perfis_escolas_municipios/Prop_raca_escola_nordeste_9ano.Rdata"))

save(prop_sexo_escola_sudeste,
     file=paste0(dirname(dirname(wd)), "/dados/perfis_escolas_municipios/Prop_sexo_escola_sudeste_9ano.Rdata"))

save(prop_raca_escola_sudeste,
     file=paste0(dirname(dirname(wd)), "/dados/perfis_escolas_municipios/Prop_raca_escola_sudeste_9ano.Rdata"))

save(prop_sexo_escola_norte,
     file=paste0(dirname(dirname(wd)), "/dados/perfis_escolas_municipios/Prop_sexo_escola_norte_9ano.Rdata"))

save(prop_raca_escola_norte,
     file=paste0(dirname(dirname(wd)), "/dados/perfis_escolas_municipios/Prop_raca_escola_norte_9ano.Rdata"))

save(prop_sexo_escola_sul,
     file=paste0(dirname(dirname(wd)), "/dados/perfis_escolas_municipios/Prop_sexo_escola_sul_9ano.Rdata"))

save(prop_raca_escola_sul,
     file=paste0(dirname(dirname(wd)), "/dados/perfis_escolas_municipios/Prop_raca_escola_sul_9ano.Rdata"))
