...
retorna_valor_esperados = function(codigo_municipio,codigo_escola){
  ...
  #2011 é o ano de referência não tem efeito
...
save(amostras_simuladas35, medias_perfis35,codigos_municipios, 
     file = paste0(path, '/simulacao/nivel/simulacao_nivel_5ano_lp_2015.Rdata'))
...
save(amostras_simuladas35, medias_perfis35, codigos_municipios, 
     file = paste0(path, '/simulacao/nivel/simulacao_nivel_5ano_mat_2015.Rdata'))