...
tamanho_amostra = dados_tudo[!is.na(Leitura) & !is.na(Matematica) & Ano %in% c(2013,2015,2017) & 
...
save(amostras_simuladas, codigos_municipios, tamanho_amostra, 
     file = paste0(path, '/simulacao/desigualdade_sexo/simulacao_sexo_5ano_lp_2017.Rdata'))
...
save(amostras_simuladas, codigos_municipios, tamanho_amostra, 
     file = paste0(path, '/simulacao/desigualdade_sexo/simulacao_sexo_5ano_mat_2017.Rdata'))