...
retorna_valor_esperados = function(codigo_municipio,codigo_escola,cod_escolas,sexo){
  ...
  # Fixa sexo conforme necessidade
...
save(amostras_simuladas, codigos_municipios, tamanho_amostra, 
     file = paste0(path, '/simulacao/desigualdade_sexo/simulacao_sexo_9ano_lp_2013.Rdata'))
...
save(amostras_simuladas, codigos_municipios, tamanho_amostra, 
     file = paste0(path, '/simulacao/desigualdade_sexo/simulacao_sexo_9ano_mat_2013.Rdata'))