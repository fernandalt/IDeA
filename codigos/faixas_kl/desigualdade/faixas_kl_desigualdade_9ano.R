...
save(corte_nse_lp_nono,corte_nse_mat_nono,
     file=paste0(path,"/dados/faixas_kl/desigualdade/ponto_corte_equidade_9ano.Rdata"))

# Salva dados resumos
save(resumo_9ano,dados_nse_mat9, dados_nse_lp9, dados_raca_mat9, 
     dados_raca_lp9, dados_sexo_mat9, dados_sexo_lp9,
     file=paste0(path,"/dados/faixas_kl/desigualdade/resumo_9ano.Rdata"))