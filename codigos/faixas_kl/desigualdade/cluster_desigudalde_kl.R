...
save(cortes_lp_nse_quinto, cortes_mat_nse_quinto, cortes_lp_raca_quinto,cortes_mat_raca_quinto,
     file=paste0(path,"/dados/faixas_kl/desigualdade/ponto_corte_desigualdade_nse_raca_5ano.Rdata"))
...
save(cortes_lp_nse_nono, cortes_mat_nse_nono, cortes_lp_raca_nono,cortes_mat_raca_nono,
     file=paste0(path,"/dados/faixas_kl/desigualdade/ponto_corte_desigualdade_nse_raca_9ano.Rdata"))