...
# Dados simulados
# MAT
load(paste0(path, "/dados/simulacao/desigualdade_sexo/simulacao_sexo_5ano_mat_2013.Rdata"))
...
dados_mat5 = rbind(dados_tudo[(Ano %in% c(2009,2011,2013)) & ID_SERIE==5,
                              c('ID_MUNICIPIO','Matematica','Sexo')],
                   dados_simulados)

#LP
load(paste0(path, "/dados/simulacao/desigualdade_sexo/simulacao_sexo_5ano_lp_2013.Rdata"))
...
dados_lp5 = rbind(dados_tudo[(Ano %in% c(2009,2011,2013)) & ID_SERIE==5,
...
# Calcula KL
desigualdade_sexo_quinto_ano_mat = dados_mat5[,.(Desigualdade.Matematica=calculaKL(Matematica[Sexo=='Feminino'],
...
desigualdade_sexo_quinto_ano_lp = dados_lp5[,.(Desigualdade.Leitura=calculaKL(Leitura[Sexo=='Feminino'],
...
desigualdade_sexo_quinto_ano_mat = desigualdade_sexo_quinto_ano_mat[ID_MUNICIPIO<6000000]
desigualdade_sexo_quinto_ano_lp = desigualdade_sexo_quinto_ano_lp[ID_MUNICIPIO<6000000]

# Salva resultado
save(desigualdade_sexo_quinto_ano_lp,desigualdade_sexo_quinto_ano_mat,
     file = paste0(path, '/dados/kl/desigualdade_sexo/kl_sexo_5ano_2013.Rdata'))