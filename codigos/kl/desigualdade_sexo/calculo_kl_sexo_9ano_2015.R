...
# Dados simulados
# MAT
load(paste0(path, "/dados/simulacao/desigualdade_sexo/simulacao_sexo_9ano_mat_2015.Rdata"))
...
#LP
load(paste0(path, "/dados/simulacao/desigualdade_sexo/simulacao_sexo_9ano_lp_2015.Rdata"))
...
save(desigualdade_sexo_nono_ano_lp,desigualdade_sexo_nono_ano_mat,
     file = paste0(path, '/dados/kl/desigualdade_sexo/kl_sexo_9ano_2015.Rdata'))