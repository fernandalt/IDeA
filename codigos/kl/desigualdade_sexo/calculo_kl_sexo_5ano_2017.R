...
dados_mat5 = rbind(dados_tudo[(Ano %in% c(2013,2015,2017)) & ID_SERIE==5,
...
dados_lp5 = rbind(dados_tudo[(Ano %in% c(2013,2015,2017)) & ID_SERIE==5,
...
save(desigualdade_sexo_quinto_ano_lp,desigualdade_sexo_quinto_ano_mat,
     file = paste0(path, '/dados/kl/desigualdade_sexo/kl_sexo_5ano_2017.Rdata'))