...
# Dados simulados
# MAT
load(paste0(path, "/dados/simulacao/desigualdade_sexo/simulacao_sexo_5ano_mat_2011.Rdata"))
...
dados_mat5 = rbind(dados_tudo[(Ano %in% c(2007,2009,2011)) & ID_SERIE==5,
                              c('ID_MUNICIPIO','Matematica','Sexo')],
                   dados_simulados)

#LP
load(paste0(path, "/dados/simulacao/desigualdade_sexo/simulacao_sexo_5ano_lp_2011.Rdata"))
...
dados_lp5 = rbind(dados_tudo[(Ano %in% c(2007,2009,2011)) & ID_SERIE==5,
...
save(desigualdade_sexo_quinto_ano_lp,desigualdade_sexo_quinto_ano_mat,
     file = paste0(path, '/dados/kl/desigualdade_sexo/kl_sexo_5ano_2011.Rdata'))