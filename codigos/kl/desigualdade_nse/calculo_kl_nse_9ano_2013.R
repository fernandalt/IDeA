...
# Dados simulados
# MAT
load(paste0(path, "/dados/simulacao/desigualdade_nse/simulacao_nse_9ano_mat_2013.Rdata"))
...
#LP
load(paste0(path, "/dados/simulacao/desigualdade_nse/simulacao_nse_9ano_lp_2013.Rdata"))
...
save(desigualdade_NSE_nono_ano_lp,desigualdade_NSE_nono_ano_mat,
     file = paste0(path, '/dados/kl/desigualdade_nse/kl_nse_9ano_2013.Rdata'))