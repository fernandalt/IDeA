...
# Dados simulados
# MAT
load(paste0(path, "/dados/simulacao/desigualdade_nse/simulacao_nse_5ano_mat_2011.Rdata"))
...
#LP
load(paste0(path, "/dados/simulacao/desigualdade_nse/simulacao_nse_5ano_lp_2011.Rdata"))
...
# Calcula KL
desigualdade_NSE_quinto_ano_mat = dados_mat5[,.(Desigualdade.Matematica=calculaKL(Matematica[classificacao_NSE==1],
...
desigualdade_NSE_quinto_ano_lp = dados_lp5[,.(Desigualdade.Leitura=calculaKL(Leitura[classificacao_NSE==1],
...
desigualdade_NSE_quinto_ano_mat = desigualdade_NSE_quinto_ano_mat[ID_MUNICIPIO<6000000]
desigualdade_NSE_quinto_ano_lp = desigualdade_NSE_quinto_ano_lp[ID_MUNICIPIO<6000000]

# Salva resultado
save(desigualdade_NSE_quinto_ano_lp,desigualdade_NSE_quinto_ano_mat,
     file = paste0(path, '/dados/kl/desigualdade_nse/kl_nse_5ano_2011.Rdata'))