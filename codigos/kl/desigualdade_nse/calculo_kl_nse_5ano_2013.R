...
# Dados simulados
# MAT
load(paste0(path, "/dados/simulacao/desigualdade_nse/simulacao_nse_5ano_mat_2013.Rdata"))
...
#LP
load(paste0(path, "/dados/simulacao/desigualdade_nse/simulacao_nse_5ano_lp_2013.Rdata"))
...
save(desigualdade_NSE_quinto_ano_lp,desigualdade_NSE_quinto_ano_mat,
     file = paste0(path, '/dados/kl/desigualdade_nse/kl_nse_5ano_2013.Rdata'))