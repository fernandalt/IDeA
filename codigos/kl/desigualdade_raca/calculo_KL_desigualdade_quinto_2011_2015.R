...
#Matematica
load("C:/Users/Erica/Dropbox/UFOP/Grupo NAVE/Trabalho Chico Soare/Atualizacao_2017/Modelo Imputacao/Dados Imputados/Dados/2011-2015/imputacao_raca_30_resultado_MAT5.Rdata")
...
dados_mat_5ano<-rbind(dados_tudo[(Ano %in% c(2011,2013,2015)) & ID_SERIE==5,c('COD_MUNICIPIO','Matematica','Raça')],
                      dados_simulados)


#LP
load("C:/Users/Erica/Dropbox/UFOP/Grupo NAVE/Trabalho Chico Soare/Atualizacao_2017/Modelo Imputacao/Dados Imputados/Dados/2011-2015/imputacao_raca_30_resultado_LP5.Rdata")
...
dados_lp_5ano<-rbind(dados_tudo[(Ano %in% c(2011,2013,2015)) & ID_SERIE==5,c('COD_MUNICIPIO','Leitura','Raça')],
                      dados_simulados)
...
save(desigualdade_raca_quinto_ano_mat,
     desigualdade_raca_quinto_ano_lp,file='Desigualdade_raca_Quinto_ano_2011_2015.Rdata')
...
load("C:/Users/Erica/Dropbox/UFOP/Grupo NAVE/Trabalho Chico Soare/Atualizacao_2017/Modelo Imputacao/Dados Imputados/Dados/2011-2015/imputacao_nse_30_resultado_MAT5.Rdata")
...
dados_mat_5ano<-rbind(dados_tudo[(Ano %in% c(2011,2013,2015)) & ID_SERIE==5,c('COD_MUNICIPIO','Matematica','classificacao_NSE')],
                      dados_simulados)


#LP
rm(amostras_simuladas)
load("C:/Users/Erica/Dropbox/UFOP/Grupo NAVE/Trabalho Chico Soare/Atualizacao_2017/Modelo Imputacao/Dados Imputados/Dados/2011-2015/imputacao_nse_30_resultado_LP5.Rdata")
...
dados_lp_5ano<-rbind(dados_tudo[(Ano %in% c(2011,2013,2015)) & ID_SERIE==5,c('COD_MUNICIPIO','Leitura','classificacao_NSE')],
                      dados_simulados)
...
save(desigualdade_NSE_quinto_ano_mat,
     desigualdade_NSE_quinto_ano_lp,file='Desigualdade_NSE_Quinto_ano_2011_2015.Rdata')
...
#Matematica
rm(amostras_simuladas)
load("C:/Users/Erica/Dropbox/UFOP/Grupo NAVE/Trabalho Chico Soare/Atualizacao_2017/Modelo Imputacao/Dados Imputados/Dados/imputacao_sexo/imputacao_sexo_MAT5_11a15.Rdata")
...
dados_mat_5ano<-rbind(dados_tudo[(Ano %in% c(2011,2013,2015)) & ID_SERIE==5,c('COD_MUNICIPIO','Matematica','Sexo')],
                      dados_simulados)


#LP
rm(amostras_simuladas)
load("C:/Users/Erica/Dropbox/UFOP/Grupo NAVE/Trabalho Chico Soare/Atualizacao_2017/Modelo Imputacao/Dados Imputados/Dados/imputacao_sexo/imputacao_sexo_LP5_11a15.Rdata")
...
dados_lp_5ano<-rbind(dados_tudo[(Ano %in% c(2011,2013,2015)) & ID_SERIE==5,c('COD_MUNICIPIO','Leitura','Sexo')],
                     dados_simulados)
...
setwd('C:\\Users\\Erica\\Dropbox\\UFOP\\Grupo NAVE\\Trabalho Chico Soare\\Atualizacao_2017\\Modelo Imputacao\\Dados Imputados\\Resultados KL')
desigualdade_sexo_quinto_ano_lp[COD_MUNICIPIO<6000000,range(nleitura_feminino)]

save(desigualdade_sexo_quinto_ano_mat,
     desigualdade_sexo_quinto_ano_lp,file='Desigualdade_sexo_Quinto_ano_2011_2015.Rdata')
