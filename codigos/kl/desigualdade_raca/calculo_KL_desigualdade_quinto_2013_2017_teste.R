...
#Matematica
load("C:/Users/Erica/Dropbox/UFOP/Grupo NAVE/Trabalho Chico Soare/Atualizacao_2017/Modelo Imputacao/Dados Imputados/Dados/2013-2017/imputacao_raca_30_resultado_MAT5.Rdata")
...
#LP
load("C:/Users/Erica/Dropbox/UFOP/Grupo NAVE/Trabalho Chico Soare/Atualizacao_2017/Modelo Imputacao/Dados Imputados/Dados/2013-2017/imputacao_raca_30_resultado_LP5.Rdata")
...
range(desigualdade_raca_quinto_ano_lp$nleitura_branco)
...
load("C:/Users/Erica/Dropbox/UFOP/Grupo NAVE/Trabalho Chico Soare/Atualizacao_2017/Modelo Imputacao/Dados Imputados/Dados/2013-2017/imputacao_nse_30_resultado_MAT5.Rdata")
...
dados_mat_5ano[COD_MUNICIPIO==3155108]

require(ggplot2)

ggplot(
  dados_mat_5ano[COD_MUNICIPIO==3155108 & (classificacao_NSE %in% c(1,5))],aes(x=Matematica,col=classificacao_NSE))+geom_density()


calculaKL( dados_mat_5ano[COD_MUNICIPIO==3155108 & (classificacao_NSE %in% c(1)),Matematica],
           dados_mat_5ano[COD_MUNICIPIO==3155108 & (classificacao_NSE %in% c(5)),Matematica]
           )


ggplot(
  dados_mat_5ano[COD_MUNICIPIO==3136405 & (classificacao_NSE %in% c(1,5))],aes(x=Matematica,col=classificacao_NSE))+geom_density()


calculaKL( dados_mat_5ano[COD_MUNICIPIO==3136405 & (classificacao_NSE %in% c(1)),Matematica],
           dados_mat_5ano[COD_MUNICIPIO==3136405 & (classificacao_NSE %in% c(5)),Matematica]
)
...
#LP
rm(amostras_simuladas)
load("C:/Users/Erica/Dropbox/UFOP/Grupo NAVE/Trabalho Chico Soare/Atualizacao_2017/Modelo Imputacao/Dados Imputados/Dados/2013-2017/imputacao_nse_30_resultado_LP5.Rdata")
...
#Matematica
rm(amostras_simuladas)
load("C:/Users/Erica/Dropbox/UFOP/Grupo NAVE/Trabalho Chico Soare/Atualizacao_2017/Modelo Imputacao/Dados Imputados/Dados/imputacao_sexo/imputacao_sexo_MAT5_13a17.Rdata")
...
dados_mat_5ano<-rbind(dados_tudo[(Ano %in% c(2013,2015,2017)) & ID_SERIE==5,c('COD_MUNICIPIO','Matematica','Sexo')],
                      dados_simulados)


#LP
rm(amostras_simuladas)
load("C:/Users/Erica/Dropbox/UFOP/Grupo NAVE/Trabalho Chico Soare/Atualizacao_2017/Modelo Imputacao/Dados Imputados/Dados/imputacao_sexo/imputacao_sexo_LP5_13a17.Rdata")
...
dados_lp_5ano<-rbind(dados_tudo[(Ano %in% c(2013,2015,2017)) & ID_SERIE==5,c('COD_MUNICIPIO','Leitura','Sexo')],
                     dados_simulados)
...
save(desigualdade_sexo_quinto_ano_mat,
     desigualdade_sexo_quinto_ano_lp,file='Desigualdade_sexo_Quinto_ano_2013_2017.Rdata')
