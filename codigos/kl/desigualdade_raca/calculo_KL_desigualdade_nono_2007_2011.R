...
#Matematica
load("C:/Users/Erica/Dropbox/UFOP/Grupo NAVE/Trabalho Chico Soare/Atualizacao_2017/Modelo Imputacao/Dados Imputados/Dados/2007-2011/imputacao_raca_30_resultado_MAT9.Rdata")
...
dados_mat_9ano<-rbind(dados_tudo[(Ano %in% c(2007,2009,2011)) & ID_SERIE==9,c('COD_MUNICIPIO','Matematica','Raça')],
                      dados_simulados)


#LP
load("C:/Users/Erica/Dropbox/UFOP/Grupo NAVE/Trabalho Chico Soare/Atualizacao_2017/Modelo Imputacao/Dados Imputados/Dados/2007-2011/imputacao_raca_30_resultado_LP9.Rdata")
...
dados_lp_9ano<-rbind(dados_tudo[(Ano %in% c(2007,2009,2011)) & ID_SERIE==9,c('COD_MUNICIPIO','Leitura','Raça')],
                      dados_simulados)
...
save(desigualdade_raca_nono_ano_mat,
     desigualdade_raca_nono_ano_lp,file='Desigualdade_raca_Nono_ano_2007_2011.Rdata')
...
load("C:/Users/Erica/Dropbox/UFOP/Grupo NAVE/Trabalho Chico Soare/Atualizacao_2017/Modelo Imputacao/Dados Imputados/Dados/2007-2011/imputacao_nse_30_resultado_MAT9.Rdata")
...
dados_mat_9ano<-rbind(dados_tudo[(Ano %in% c(2007,2009,2011)) & ID_SERIE==9,c('COD_MUNICIPIO','Matematica','classificacao_NSE')],
                      dados_simulados)


#LP
rm(amostras_simuladas)
load("C:/Users/Erica/Dropbox/UFOP/Grupo NAVE/Trabalho Chico Soare/Atualizacao_2017/Modelo Imputacao/Dados Imputados/Dados/2007-2011/imputacao_nse_30_resultado_LP9.Rdata")
...
dados_lp_9ano<-rbind(dados_tudo[(Ano %in% c(2007,2009,2011)) & ID_SERIE==9,c('COD_MUNICIPIO','Leitura','classificacao_NSE')],
                      dados_simulados)
...
save(desigualdade_NSE_nono_ano_mat,
     desigualdade_NSE_nono_ano_lp,file='Desigualdade_NSE_Nono_ano_2007_2011.Rdata')
...
#Matematica
rm(amostras_simuladas)
load("C:/Users/Erica/Dropbox/UFOP/Grupo NAVE/Trabalho Chico Soare/Atualizacao_2017/Modelo Imputacao/Dados Imputados/Dados/imputacao_sexo/imputacao_sexo_MAT9_07a11.Rdata")
...
dados_mat_9ano<-rbind(dados_tudo[(Ano %in% c(2007,2009,2011)) & ID_SERIE==9,c('COD_MUNICIPIO','Matematica','Sexo')],
                      dados_simulados)
...
#LP
rm(amostras_simuladas)
load("C:/Users/Erica/Dropbox/UFOP/Grupo NAVE/Trabalho Chico Soare/Atualizacao_2017/Modelo Imputacao/Dados Imputados/Dados/imputacao_sexo/imputacao_sexo_LP9_07a11.Rdata")
...
dados_lp_9ano<-rbind(dados_tudo[(Ano %in% c(2007,2009,2011)) & ID_SERIE==9,c('COD_MUNICIPIO','Leitura','Sexo')],
                     dados_simulados)
...
save(desigualdade_sexo_nono_ano_mat,
     desigualdade_sexo_nono_ano_lp,file='Desigualdade_sexo_Nono_ano_2007_2011.Rdata')
