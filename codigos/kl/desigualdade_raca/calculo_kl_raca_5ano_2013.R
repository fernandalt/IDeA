...
# Dados simulados
# MAT
load(paste0(path, "/dados/simulacao/desigualdade_raca/simulacao_raca_5ano_mat_2013.Rdata"))
...
#LP
load(paste0(path, "/dados/simulacao/desigualdade_raca/simulacao_raca_5ano_lp_2013.Rdata"))
...
save(desigualdade_raca_quinto_ano_lp,desigualdade_raca_quinto_ano_mat,
     file = paste0(path, '/dados/kl/desigualdade_raca/kl_raca_5ano_2013.Rdata'))