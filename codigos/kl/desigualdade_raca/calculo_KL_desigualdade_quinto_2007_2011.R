...
#Matematica
load("C:/Users/Erica/Dropbox/UFOP/Grupo NAVE/Trabalho Chico Soare/Atualizacao_2017/Modelo Imputacao/Dados Imputados/Dados/2007-2011/imputacao_raca_30_resultado_MAT5.Rdata")
...
dados_mat_5ano<-rbind(dados_tudo[(Ano %in% c(2007,2009,2011)) & ID_SERIE==5,c('COD_MUNICIPIO','Matematica','Raça')],
                      dados_simulados)


#LP
load("C:/Users/Erica/Dropbox/UFOP/Grupo NAVE/Trabalho Chico Soare/Atualizacao_2017/Modelo Imputacao/Dados Imputados/Dados/2007-2011/imputacao_raca_30_resultado_LP5.Rdata")
...
dados_lp_5ano<-rbind(dados_tudo[(Ano %in% c(2007,2009,2011)) & ID_SERIE==5,c('COD_MUNICIPIO','Leitura','Raça')],
                      dados_simulados)
...
save(desigualdade_raca_quinto_ano_mat,
     desigualdade_raca_quinto_ano_lp,file='Desigualdade_raca_Quinto_ano_2007_2011.Rdata')
...
load("C:/Users/Erica/Dropbox/UFOP/Grupo NAVE/Trabalho Chico Soare/Atualizacao_2017/Modelo Imputacao/Dados Imputados/Dados/2007-2011/imputacao_nse_30_resultado_MAT5.Rdata")
...
dados_mat_5ano<-rbind(dados_tudo[(Ano %in% c(2007,2009,2011)) & ID_SERIE==5,c('COD_MUNICIPIO','Matematica','classificacao_NSE')],
                      dados_simulados)


#LP
rm(amostras_simuladas)
load("C:/Users/Erica/Dropbox/UFOP/Grupo NAVE/Trabalho Chico Soare/Atualizacao_2017/Modelo Imputacao/Dados Imputados/Dados/2007-2011/imputacao_nse_30_resultado_LP5.Rdata")
...
dados_lp_5ano<-rbind(dados_tudo[(Ano %in% c(2007,2009,2011)) & ID_SERIE==5,c('COD_MUNICIPIO','Leitura','classificacao_NSE')],
                      dados_simulados)
...
save(desigualdade_NSE_quinto_ano_mat,
     desigualdade_NSE_quinto_ano_lp,file='Desigualdade_NSE_Quinto_ano_2007_2011.Rdata')
...
#Matematica
rm(amostras_simuladas)
load("C:/Users/Erica/Dropbox/UFOP/Grupo NAVE/Trabalho Chico Soare/Atualizacao_2017/Modelo Imputacao/Dados Imputados/Dados/imputacao_sexo/imputacao_sexo_MAT5_07a11.Rdata")
...
codigos_municipios[ID_MUNICIPIO== 5213400]
...
dados_mat_5ano<-rbind(dados_tudo[(Ano %in% c(2007,2009,2011)) & ID_SERIE==5,c('COD_MUNICIPIO','Matematica','Sexo')],
                      dados_simulados)


#LP
rm(amostras_simuladas)
load("C:/Users/Erica/Dropbox/UFOP/Grupo NAVE/Trabalho Chico Soare/Atualizacao_2017/Modelo Imputacao/Dados Imputados/Dados/imputacao_sexo/imputacao_sexo_LP5_07a11.Rdata")
...
dados_lp_5ano<-rbind(dados_tudo[(Ano %in% c(2007,2009,2011)) & ID_SERIE==5,c('COD_MUNICIPIO','Leitura','Sexo')],
                     dados_simulados)
...
desigualdade_sexo_quinto_ano_lp[COD_MUNICIPIO<6000000]


save(desigualdade_sexo_quinto_ano_mat,
     desigualdade_sexo_quinto_ano_lp,file='Desigualdade_sexo_Quinto_ano_2007_2011.Rdata')
