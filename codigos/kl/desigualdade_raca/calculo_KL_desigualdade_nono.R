...
#Matematica
load("C:/Users/Erica/Dropbox/UFOP/Grupo NAVE/Trabalho Chico Soare/Atualizacao_2017/Modelo Imputacao/Dados Imputados/Dados/imputacao_raca_30_resultado_MAT9.Rdata")
...
dados_mat_9ano<-rbind(dados_tudo[(Ano %in% c(2013,2015,2017)) & ID_SERIE==9,c('COD_MUNICIPIO','Matematica','Raça')],
                      dados_simulados)


#LP
load("C:/Users/Erica/Dropbox/UFOP/Grupo NAVE/Trabalho Chico Soare/Atualizacao_2017/Modelo Imputacao/Dados Imputados/Dados/imputacao_raca_30_resultado_LP9.Rdata")
...
dados_lp_9ano<-rbind(dados_tudo[(Ano %in% c(2013,2015,2017)) & ID_SERIE==9,c('COD_MUNICIPIO','Leitura','Raça')],
                      dados_simulados)
...
save(desigualdade_raca_nono_ano_mat,
     desigualdade_raca_nono_ano_lp,file='Desigualdade_raca_Nono_ano_2013_2017.Rdata')
...
rm(amostras_simuladas)
load("C:/Users/Erica/Dropbox/UFOP/Grupo NAVE/Trabalho Chico Soare/Atualizacao_2017/Modelo Imputacao/Dados Imputados/Dados/imputacao_nse_30_resultado_MAT9.Rdata")
...
dados_mat_9ano<-rbind(dados_tudo[(Ano %in% c(2013,2015,2017)) & ID_SERIE==9,c('COD_MUNICIPIO','Matematica','classificacao_NSE')],
                      dados_simulados)


#LP
rm(amostras_simuladas)
load("C:/Users/Erica/Dropbox/UFOP/Grupo NAVE/Trabalho Chico Soare/Atualizacao_2017/Modelo Imputacao/Dados Imputados/Dados/imputacao_nse_30_resultado_LP9.Rdata")
...
dados_lp_9ano<-rbind(dados_tudo[(Ano %in% c(2013,2015,2017)) & ID_SERIE==9,c('COD_MUNICIPIO','Leitura','classificacao_NSE')],
                      dados_simulados)
...
save(desigualdade_NSE_nono_ano_mat,
     desigualdade_NSE_nono_ano_lp,file='Desigualdade_NSE_Nono_ano_2013_2017.Rdata')
