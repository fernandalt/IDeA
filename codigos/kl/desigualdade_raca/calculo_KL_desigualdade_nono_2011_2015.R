...
#Matematica
load("C:/Users/Erica/Dropbox/UFOP/Grupo NAVE/Trabalho Chico Soare/Atualizacao_2017/Modelo Imputacao/Dados Imputados/Dados/2011-2015/imputacao_raca_30_resultado_MAT9.Rdata")
...
dados_mat_9ano<-rbind(dados_tudo[(Ano %in% c(2011,2013,2015)) & ID_SERIE==9,c('COD_MUNICIPIO','Matematica','Raça')],
                      dados_simulados)


#LP
load("C:/Users/Erica/Dropbox/UFOP/Grupo NAVE/Trabalho Chico Soare/Atualizacao_2017/Modelo Imputacao/Dados Imputados/Dados/2011-2015/imputacao_raca_30_resultado_LP9.Rdata")
...
dados_lp_9ano<-rbind(dados_tudo[(Ano %in% c(2011,2013,2015)) & ID_SERIE==9,c('COD_MUNICIPIO','Leitura','Raça')],
                      dados_simulados)
...
save(desigualdade_raca_nono_ano_mat,
     desigualdade_raca_nono_ano_lp,file='Desigualdade_raca_Nono_ano_2011_2015.Rdata')
...
load("C:/Users/Erica/Dropbox/UFOP/Grupo NAVE/Trabalho Chico Soare/Atualizacao_2017/Modelo Imputacao/Dados Imputados/Dados/2011-2015/imputacao_nse_30_resultado_MAT9.Rdata")
...
dados_mat_9ano<-rbind(dados_tudo[(Ano %in% c(2011,2013,2015)) & ID_SERIE==9,c('COD_MUNICIPIO','Matematica','classificacao_NSE')],
                      dados_simulados)


#LP
rm(amostras_simuladas)
load("C:/Users/Erica/Dropbox/UFOP/Grupo NAVE/Trabalho Chico Soare/Atualizacao_2017/Modelo Imputacao/Dados Imputados/Dados/2011-2015/imputacao_nse_30_resultado_LP9.Rdata")
...
dados_lp_9ano<-rbind(dados_tudo[(Ano %in% c(2011,2013,2015)) & ID_SERIE==9,c('COD_MUNICIPIO','Leitura','classificacao_NSE')],
                      dados_simulados)
...
desigualdade_NSE_nono_ano_lp[COD_MUNICIPIO<6000000]


save(desigualdade_NSE_nono_ano_mat,
     desigualdade_NSE_nono_ano_lp,file='Desigualdade_NSE_Nono_ano_2011_2015.Rdata')
...
#Matematica
rm(amostras_simuladas)
load("C:/Users/Erica/Dropbox/UFOP/Grupo NAVE/Trabalho Chico Soare/Atualizacao_2017/Modelo Imputacao/Dados Imputados/Dados/imputacao_sexo/imputacao_sexo_MAT9_11a15.Rdata")
...
dados_mat_9ano<-rbind(dados_tudo[(Ano %in% c(2011,2013,2015)) & ID_SERIE==9,c('COD_MUNICIPIO','Matematica','Sexo')],
                      dados_simulados)


#LP
rm(amostras_simuladas)
load("C:/Users/Erica/Dropbox/UFOP/Grupo NAVE/Trabalho Chico Soare/Atualizacao_2017/Modelo Imputacao/Dados Imputados/Dados/imputacao_sexo/imputacao_sexo_LP9_11a15.Rdata")
...
dados_aux<-data.table(COD_MUNICIPIO=codigos_municipios[1,ID_MUNICIPIO],
                      Leitura=amostras_simuladas[[1]]$Leitura,
                      Sexo=amostras_simuladas[[1]]$Sexo[1])
...
dados_lp_9ano<-rbind(dados_tudo[(Ano %in% c(2011,2013,2015)) & ID_SERIE==9,c('COD_MUNICIPIO','Leitura','Sexo')],
                     dados_simulados)
...
save(desigualdade_sexo_nono_ano_mat,
     desigualdade_sexo_nono_ano_lp,file='Desigualdade_sexo_Nono_ano_2011_2015.Rdata')
