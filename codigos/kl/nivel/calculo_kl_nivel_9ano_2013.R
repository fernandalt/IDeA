...
#Matematica
load("C:/Users/Erica/Dropbox/UFOP/Grupo NAVE/Trabalho Chico Soare/Atualizacao_2017/Modelo Imputacao/Dados Imputados/Dados/2009-2013/imputacao_nivel_40_resultado_MAT9.Rdata")
...
dados_mat_9ano<-rbind(dados_tudo[(Ano %in% c(2009,2011,2013)) & ID_SERIE==9,c('COD_MUNICIPIO','Matematica')],
                      dados_simulados)


#LP
load("C:/Users/Erica/Dropbox/UFOP/Grupo NAVE/Trabalho Chico Soare/Atualizacao_2017/Modelo Imputacao/Dados Imputados/Dados/2009-2013/imputacao_nivel_40_resultado_LP9.Rdata")
...
dados_lp_9ano<-rbind(dados_tudo[(Ano %in% c(2009,2011,2013)) & ID_SERIE==9,c('COD_MUNICIPIO','Leitura')],
                      dados_simulados)
...
save(kl_nono_ano_lp,kl_nono_ano_mat,file='KL_Nono_ano_2009_2013.Rdata')
