...
# Dados simulados
# MAT
load(paste0(path, "/dados/simulacao/nivel/simulacao_nivel_9ano_mat_2017.Rdata"))
...
#LP
load(paste0(path, "/dados/simulacao/nivel/simulacao_nivel_9ano_lp_2017.Rdata"))
...
save(kl_nono_ano_lp,kl_nono_ano_mat,
     file = paste0(path, '/dados/kl/nivel/kl_nivel_9ano_2017.Rdata'))