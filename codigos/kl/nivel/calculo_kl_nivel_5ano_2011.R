...
# Dados simulados
# MAT
load(paste0(path, "/dados/simulacao/nivel/simulacao_nivel_5ano_mat_2011.Rdata"))
...
#LP
load(paste0(path, "/dados/simulacao/nivel/simulacao_nivel_5ano_lp_2011.Rdata"))
...
save(kl_quinto_ano_lp,kl_quinto_ano_mat,
     file = paste0(path, '/dados/kl/nivel/kl_nivel_5ano_2011.Rdata'))