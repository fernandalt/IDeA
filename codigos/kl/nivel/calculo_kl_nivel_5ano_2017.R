...
#Matematica
load("C:/Users/Erica/Dropbox/UFOP/Grupo NAVE/Trabalho Chico Soare/Atualizacao_2017/Modelo Imputacao/Dados Imputados/Dados/imputacao_nivel_35_resultado_MAT5.Rdata")
...
dados_mat_5ano<-rbind(dados_tudo[(Ano %in% c(2013,2015,2017)) & ID_SERIE==5,c('COD_MUNICIPIO','Matematica')],
                      dados_simulados)


#LP
load("C:/Users/Erica/Dropbox/UFOP/Grupo NAVE/Trabalho Chico Soare/Atualizacao_2017/Modelo Imputacao/Dados Imputados/Dados/imputacao_nivel_35_resultado_LP5.Rdata")
...
dados_lp_5ano<-rbind(dados_tudo[(Ano %in% c(2013,2015,2017)) & ID_SERIE==5,c('COD_MUNICIPIO','Leitura')],
                      dados_simulados)
...
load("C:/Users/Erica/Dropbox/UFOP/Grupo NAVE/Trabalho Chico Soare/Atualizacao_2017/Modelo Imputacao/Dados Imputados/Referencias_victor.RData")
...
save(kl_quinto_ano_lp,kl_quinto_ano_mat,file='KL_Quinto_ano_2013_2017.Rdata')
